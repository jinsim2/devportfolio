...
export function ResumeDetail() {
  ...
  return (
    <Dialog open={true} onOpenChange={handleClose}>
      <DialogContent className="max-w-[939px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-3xl font-bold">이력서</DialogTitle>
        </DialogHeader>
        <div className="w-[898px] p-12 bg-white rounded-lg shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-neutral-300/30 inline-flex flex-col justify-start items-start gap-12">
          <div className="self-stretch pb-12 border-b border-neutral-300/30 inline-flex justify-start items-start gap-8">
            <div className="flex-1 h-48 relative">
              <div className="w-[684px] left-0 top-[-1px] absolute inline-flex flex-col justify-start items-start">
                <div className="justify-center text-gray-950 text-6xl font-extrabold font-['Pretendard'] leading-[70.40px]">강진석</div>
              </div>
              <div className="w-[684px] left-0 top-[78.39px] absolute inline-flex flex-col justify-start items-start">
                <div className="justify-center text-zinc-700 text-2xl font-semibold font-['Inter'] leading-8">Senior Full-Stack Developer</div>
              </div>
              <div className="w-[684px] h-16 left-0 top-[135.98px] absolute">
                {/* 이메일 */}
                <div className="w-52 h-6 left-0 top-0 absolute flex items-center gap-2">
                  <img src={icon_resume_01} alt="email" className="w-4 h-4 object-contain" />
                  <div className="text-zinc-700 text-base font-normal font-['Inter'] leading-6">chienttao@google.com</div>
                </div>
                {/* 전화번호 */}
                <div className="w-36 h-6 left-[213.22px] top-0 absolute flex items-center gap-2">
                  <img src={icon_resume_02} alt="phone" className="w-4 h-4 object-contain" />
                  <div className="text-zinc-700 text-base font-normal font-['Inter'] leading-6">010-9441-8323</div>
                </div>
                {/* 주소 */}
                <div className="w-40 h-6 left-[368.84px] top-0 absolute flex items-center gap-2">
                  <img src={icon_resume_03} alt="location" className="w-4 h-4 object-contain" />
                  <div className="text-zinc-700 text-base font-normal font-['Pretendard'] leading-6">부산광역시 연제구</div>
                </div>
                {/* 깃허브 */}
                <div className="w-44 h-6 left-0 top-[37.60px] absolute flex items-center gap-2">
                  <img src={icon_resume_04} alt="github" className="w-4 h-4 object-contain" />
                  <div className="text-zinc-700 text-base font-normal font-['Inter'] leading-6">github.com/jinsim2</div>
                </div>
              </div>
            </div>
            <div className="w-32 h-36 bg-zinc-200 rounded-xl inline-flex flex-col justify-center items-start overflow-hidden">
              <img className="w-32 h-40" src={photo_id} />
            </div>
          </div>
          <div className="self-stretch flex flex-col justify-start items-start gap-6">
            ...
            <div className="self-stretch flex flex-col justify-start items-start">
              <div className="self-stretch justify-center"><span className="text-zinc-900 text-lg font-normal font-['Pretendard'] leading-7">16년의 IT 인프라 운영 및 기술 교육 경험을 바탕으로, </span><span className="text-zinc-900 text-lg font-semibold font-['Pretendard'] leading-7">탄탄한 DevOps 역량을 갖춘 풀스택 개발자</span><span className="text-zinc-900 text-lg font-normal font-['Pretendard'] leading-7">입니다.<br />AWS 클라우드 도입 및 컨테이너 기반(Docker) 배포 환경을 직접 구축하며 서버 최적화와 안정성에 기여<br />해 왔습니다. 현재는 React와 Django(DRF)를 활용한 모던 웹 아키텍처 설계와 레거시 시스템 리팩토링에<br />주력하고 있으며, 인프라 단의 네트워크 설계부터 프론트엔드의 사용자 중심 UI/UX 구현까지 전체 시스템<br />을 조망하고 문제를 해결하는 데 강점이 있습니다.</span></div>
            </div>
            {/* 역량 항목 그리드 컨테이너 */}
            <div className="self-stretch p-8 bg-zinc-50 rounded-xl border border-zinc-200 grid grid-cols-2 gap-x-8 gap-y-6">
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-6">
            ...
            <div className="self-stretch grid grid-cols-2 gap-4">
              ...
              {/* 5. 인프라/DevOps (2칸 차지) */}
              <div className="col-span-2 px-6 py-8 bg-zinc-100 rounded-xl border border-zinc-200 space-y-2">
